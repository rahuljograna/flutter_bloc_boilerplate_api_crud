...
import 'package:flutter_bloc_boilerplate/app/presentation/pages/home/bloc/home_bloc.dart';
                              ...
                              leading: ClipRRect(
                                child: SizedBox.fromSize(
                                  ...
                                  child: FadeInImage(
                                    ...
                                    fit: BoxFit.cover,
                                    image: NetworkImage(
                                        '${Environments.apiBaseURL}storage/images/${state.list[index].cover}'),
                                            ...
                                            content: SingleChildScrollView(
                                              child: Column(
                                                children: [
                                                  ...
                                                  Text(
                                                    'to delete ${state.list[index].title!} post ?',
                                                    style: TextStyle(
                                                      fontSize:
                                                          Theme.of(context)
                                                              .textTheme
